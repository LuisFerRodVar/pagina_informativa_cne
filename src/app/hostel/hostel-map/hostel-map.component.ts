...
@Component({
  selector: 'app-hostel-map',
  standalone: true,
  imports: [],
  templateUrl: './hostel-map.component.html',
  styleUrls: ['./hostel-map.component.css','../../cce/cce-map/cce-map.component.css' ]
})
export class HostelMapComponent {
  ...
  navigateCarousel(change: number){
    this.carousel += change;
  }
}
